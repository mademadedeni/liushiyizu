...
// require('../webApp/components/header/header.js');
// require('../webApp/components/login/login.js');
...
router.get('/', async (ctx, next) => {
	...
	// 	template: `
	// 		<div id="app">
	// 			<liu-header :tab-id="1" @to-login="toLogin"></liu-header>
	// 			<div class="index_banner_box">
	// 				<canvas id="canvas" class="canvas"></canvas>
	// 			</div>
	// 			<liu-footer></liu-footer>
	// 			<liu-login :show-login="showLogin" @close-login="closeLogin" @to-login="toLogin"></liu-login>
	// 		</div>
	// 	`,
	// 	data: {
	// 		list: [],
	...
	//   template: require('fs').readFileSync(url.webApp + '/dist/html/index.html', 'utf-8')
	// })
